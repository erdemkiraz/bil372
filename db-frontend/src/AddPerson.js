...
class AddPerson extends React.Component {
    ...
    constructor(props) {
        ...
        this.insertPrequisite = this.insertPrequisite.bind(this)
                ...
                <TabView activeIndex={this.state.activeIndex}
                    ...
                    <TabPanel header="Insert TakesCourse">
                     ...
                     <TabPanel header="Insert Prequisite">
                        ...
                        <Button label="Insert Prequisite" className="p-button-raised p-button-rounded"
                                onClick={this.insertPrequisite}/>
                    </TabPanel>
