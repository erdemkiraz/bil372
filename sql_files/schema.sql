...
CREATE TABLE TAKES_COURSE (
  ...
  grade            varchar(3),
  PRIMARY KEY (s_tckn, course_id)
);

CREATE TABLE ASSISTS (
  sa_tckn     bigint,
  course_id   varchar(7),
  PRIMARY KEY (sa_tckn, course_id)
);
...
CREATE TABLE TEACHES (
  ...
  tyear        varchar(10),
  tname        varchar(10),
  PRIMARY KEY (prof_tckn, course_id, tyear, tname)
);

CREATE TABLE PREREQUISITE (
  course_id               varchar(7),
  prerequiste_course_id   varchar(7),
  PRIMARY KEY (course_id, prerequiste_course_id)
);
...
CREATE TABLE LIMITS (
  ...
  quota         int,
  PRIMARY KEY (company_id, major_name)
);
